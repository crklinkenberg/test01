...
class GlobalGradingSetValues extends Model
{
    protected $table = 'global_grading_set_values';
     ...
     */
    protected $fillable = [
        'global_grading_sets_id', 'format_name', 'format_example', 'format_custom_signs', 'format_custom_tag', 'format_grade', 'active', 'ip_address', 'stand', 'bearbeiter_id', 'ersteller_datum', 'ersteller_id'
    ];
    ...
    /**
     * The global grading set values that belong to Global grading set.
     */
    public function globalGradingSets()
    {
        return $this->belongsTo('App\GlobalGradingSets');
    }
