...
class GlobalGradingSettings extends Model
{
    protected $table = 'global_grading_settings';
     ...
     */
    protected $fillable = [
        'normal', 'sperrschrift', 'kursiv', 'kursiv_sperrschrift', 'bold', 'bold_sperrschrift', 'bold_kursiv', 'bold_kursiv_sperrschrift', 'bold_gross', 'active', 'ip_address', 'stand', 'bearbeiter_id', 'ersteller_datum', 'ersteller_id'
    ];
