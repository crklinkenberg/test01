...
class SynonymDe extends Model
{
     ...
     */
    protected $fillable = [
        'word', 'strict_synonym', 'synonym_partial_1', 'synonym_partial_2', 'synonym_general', 'synonym_minor', 'synonym_nn', 'active', 'ip_address', 'stand', 'bearbeiter_id', 'ersteller_datum', 'ersteller_id'
    ];
