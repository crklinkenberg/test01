...
class SynonymEnController extends Controller
{
    ...
    public function __construct(\App\User $user, \App\Admin $admin, \App\QuelleImportMaster $quelleImportMaster, \App\SynonymEn $synonymEn){
        $this->user = $user;
        $this->admin = $admin;
    ...
    **/
	...
	{ 
		...
		try{
		    ...
		    $synonymEnData=$this->synonymEn->where('synonym_id', $input['synonym_id'])->first();
