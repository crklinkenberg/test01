...
class SynonymDeController extends Controller
{
    ...
    public function __construct(\App\User $user, \App\Admin $admin, \App\QuelleImportMaster $quelleImportMaster, \App\SynonymDe $synonymDe){
        $this->user = $user;
        $this->admin = $admin;
    ...
    **/
	...
	{ 
		...
		try{
		    ...
		    $synonymDeData=$this->synonymDe->where('synonym_id', $input['synonym_id'])->first();
