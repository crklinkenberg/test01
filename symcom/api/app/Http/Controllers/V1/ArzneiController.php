    ...
    **/
	...
	{ 
		...
		try{
        	...
        	$insertData['synonyms']= (isset($input['synonyms']) and $input['synonyms'] != "") ? $input['synonyms'] : NULL;
	...
	{ 
		...
		try{
	        ...
	        if($quelleData === null){
	        	...
	        	$updateData['synonyms']= (isset($input['synonyms']) and $input['synonyms'] != "") ? $input['synonyms'] : NULL;
