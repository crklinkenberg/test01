...
class Quelle extends Model
{
     ...
     */
    protected $fillable = [
        'quelle_type_id', 'quelle_schema_id', 'herkunft_id', 'code', 'titel', 'jahr', 'band', 'jahrgang', 'nummer', 'supplementheft', 'auflage', 'file_url', 'verlag_id', 'sprache', 'source_type', 'autor_or_herausgeber', 'kommentar', 'is_coding_with_symptom_number', 'is_materia_medica', 'active', 'ip_address', 'stand', 'bearbeiter_id', 'ersteller_datum', 'ersteller_id'
    ];
    ...
    /**
     * The pruefer that belong to the quelle.
     */
    public function pruefer()
    {
        return $this->belongsToMany('App\Pruefer', 'quelle_pruefer', 'quelle_id', 'pruefer_id', 'quelle_id', 'pruefer_id');
    }
    ...
    /**
     * The Grading settings that belong to the quelle.
     */
    public function quelleGradingSettings()
    {
        return $this->hasOne('App\QuelleGradingSettings', 'quelle_id', 'quelle_id');
    }

    /**
     * Symptom type settings that belong to the quelle.
     */
    public function quelleSymptomSettings()
    {
        return $this->hasOne('App\QuelleSymptomSettings', 'quelle_id', 'quelle_id');
    }
