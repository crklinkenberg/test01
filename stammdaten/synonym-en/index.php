					            ...
					            <table id="dataTable" class="table-loader table table-bordered table-striped display table-hover custom-table">
					                <thead>
						                <tr>
											...
											<th>Partielles Synonym I</th>
											<th>Partielles Synonym II</th>
					                	...
					                	if($synonymEn != null && $synonymEn != '') { 
							                ...
							                <tr>
												...
												<td><a href="#rowlinkModal" 
														data-id="<?php echo $synon['synonym_id']; ?>" data-type="synonym_en" data-title="Synonym"
														data-toggle="modal"><?php echo $synon['word']; ?></a></td>
