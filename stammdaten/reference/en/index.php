			...
			<div class="col-md-12">
				<div class="box box-success">
		            ...
		            <div class="box-header with-border">
						<h3 class="box-title">
							<a href="<?php echo $absoluteUrl;?>stammdaten/reference/add" class="btn btn-success"><i class="fa fa-plus"></i> &nbsp; Neuer Literatur</a>
						</h3>
		            </div>
		            <?php  } ?>
		            <!-- /.box-header -->
					                	...
					                	if($autoren != null && $autoren != '') { 
							                ...
							                <tr>
												...
												<td class="rowlink-skip">
													<a class="btn btn-warning btn-sm" href="<?php echo $absoluteUrl;?>stammdaten/reference/edit?reference_id=<?php echo $autor['autor_id']; ?>" title="Ändern"><i class="fa fa-edit"></i></a>
			            	       	            </td>
			            	       	            <?php  } ?>
							                </tr>
							            <?php } 
