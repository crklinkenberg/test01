...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li> Stemmdaten</li>
        <li class="active">Literatur</li> <!-- Reference -->
      </ol>
    </section>
			...
			<div class="col-md-12">
				<div class="box box-success">
		            ...
		            <div class="box-header with-border">
						<h3 class="box-title">
							<a href="<?php echo $absoluteUrl;?>stammdaten/reference/de/add" class="btn btn-success"><i class="fa fa-plus"></i> &nbsp; Neuer Literatur</a>
						</h3>
		            </div>
		            <?php  } ?>
		            <!-- /.box-header -->
