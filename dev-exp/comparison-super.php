...
<?php
    ...
    if(isset($_POST['new_comparison_btn']))
    {
        ...
        header("Location: ".$baseUrl."comparison-super.php");
        die();
    }
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="row control-panel-btns">
                                                <div class="col-md-3">
                                                    <form id="saveSubmitGenNs" action="<?php echo $baseUrl?>comparison-super.php" method="POST">
                                                ...
                                                <div class="col-md-3">
                                                    <form id="saveSubmitNs" action="<?php echo $baseUrl?>comparison-super.php?open_conn=1" method="POST">
                                                        <input type="hidden" name="custom_listing">
                                                ...
                                                <div class="col-md-3">
                                                    <form id="saveSubmitNsP" action="<?php echo $baseUrl?>comparison-super.php?open_conn=1" method="POST">
                                                        <input type="hidden" name="custom_listing">
                                                ...
                                                <div class="col-md-3">
                                                    <form id="saveSubmitNsF" action="<?php echo $baseUrl?>comparison-super.php?open_conn=1" method="POST">
                                                        <input type="hidden" name="custom_listing">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-1">
                                            <form id="saveSubmit" action="<?php echo $baseUrl.'comparison-super.php';?>" method="POST">
                                    ...
                                    <?php
                                        ...
                                        if($comparisonTable != "" AND $comparisonTableStatus != "processing")
                                        {
                                            ...
                                            if(!empty($initialCustomVal)){
                                                ...
                                                header("Location: ".$baseUrl."comparison-super.php?page=1&per_page_initial_symptom_number=".$perPageInitialSymptomNumber."&unmarked_initials_check=".$unmarkedInitialsCheck."&ns_editing=".$editingNs."&open_conn=1");
                                                die();
                                            }
                                                    ...
                                                    <?php
                                                        ...
                                                        else
                                                        {
                                                            if($page>4)
                                                            {
                                                                ?>
                                                                    <li class="page-item">
                                                                    <a class="page-link  text-primary" href="comparison-super.php?page=<?php echo $fixedInitialPage;?>&per_page_initial_symptom_number=<?php echo $perPageInitialSymptomNumber?>&unmarked_initials_check=<?php echo $unmarkedInitialsCheck?>&ns_editing=<?php echo $editingNs?>">1</a>
                                                                    </li>
                                                                <?php
                                                            }
                                                            ...
                                                            ?>
                                                                <li class="page-item">
                                                                <a class="page-link  text-primary" href="comparison-super.php?page=<?php echo $totalPage;?>&per_page_initial_symptom_number=<?php echo $perPageInitialSymptomNumber?>&id_to_continue=<?php echo $lastPage;?>&unmarked_initials_check=<?php echo $unmarkedInitialsCheck?>&ns_editing=<?php echo $editingNs?>"><?php echo $totalPage?></a>
                                                                </li>
                                                            <?php
                                                            }	
                                                        }
            ...
            if($.inArray("0", comparingSourceLanguage) !== -1){
                ...
                request.done(function(responseData) {
                    ...
                    if(resultData.result_data.is_table_exist == 0){
                        ...
                        window.location.href = "<?php echo $baseUrl?>comparison-super.php";
                    }
                });
