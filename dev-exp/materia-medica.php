                                        ...
                                        <table class="table table-bordered heading-table heading-table-bg table-vertical-middle-td">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 8%;" class="text-center">Final View</th>
                                                    <th style="width: 5%;" class="text-center">RMM</th>
                                                    <th style="width: 11%;">Date</th>
                                                    <th style="width: 14%;">Arznei</th>
                                                    <th class="text-center" style="width: 8%;">Synonym</th>
                                                    <!-- <th style="width: 15%;">Ongoing vesrion</th> -->
                                                    <!-- <th style="width: 9%;">Approved</th> -->
                                                    <th style="width: 3%;" class="text-center"><a title="Edit comparison name" class="text-info" href="javascript:void(0)"><i class="fas fa-edit mm-fa-icon"></i></a></th>
                                                    <th class="text-center" style="width: 5%;">de</th>
                                                    <th class="text-center" style="width: 5%;">en</th>
                                                    <th style="width: 3%;" class="text-center"><a title="Delete" class="text-danger" href="javascript:void(0)"><i class="fas fa-trash-alt mm-fa-icon"></i></a></th>
                                                </tr>
                                            </thead>
                                        </table>
                                                        ...
                                                        if(mysqli_num_rows($comparisonCompletedResult) > 0){
                                                            ...
                                                            while($row = mysqli_fetch_array($comparisonCompletedResult)){
                                                                ...
                                                                <tr id="row_<?php echo $row['id']; ?>">
                                                                    ...
                                                                    <td id="comparison_name_container_<?php echo $row['quelle_id']; ?>" style="width: 20%;">
                                                                        <?php 
                                                                            if($row['final_view'] == "1"){ 
                                                                                $quelle_name = $row['titel'];
                                                                        ?>
                                                                                <a class="text-info history-table-anchor-tag" href="comparison-final-view.php?comid=<?php echo $row['pre_comparison_master_data_id']; ?>"><?php echo $row['titel']; ?></a>
                                                                        <?php 
                                                                            }else if($row['pre_comparison_master_data_id'] != ""){ 
                                                                                $quelle_name = $row['titel'];
                                                                        ?>
                                                                                <a class="text-info history-table-anchor-tag" href="comparison.php?comid=<?php echo $row['pre_comparison_master_data_id']; ?>"><?php echo $row['titel']; ?></a>
                                                                        <?php 
                                                                            }
                                                                            else
                                                                            {
                                                                                $quelle_name = $row['titel'];
                                                                        ?>
                                                                            <a class="text-info history-table-anchor-tag" href="source-symptoms.php?mid=<?php echo $row['id']; ?>"><?php echo $row['titel']; ?></a>
                                                                        <?php
                                                                                // echo $row["titel"];
                                                                            } 
                                                                        ?>
                                                                    ...
                                                                    <td style="width: 8%;" class="text-center">
                                                                        <?php 
                                                                            if($row['final_view'] == "1"){
                                                                                echo '<a class="text-info history-table-anchor-tag" href="comparison-final-view.php?comid='.$row['pre_comparison_master_data_id'].'">Available</a>';
                                                                            }else{
                                                                                echo "-";
                                                                            }
                                                                        ?>
                                                                    ...
                                                                    <td style="width: 5%;" class="text-center">
                                                                        <?php  
                                                                            if($row['final_view'] == "1"){
                                                                                if($row['rmm'] == "1"){
                                                                                    echo '<a id="rmm_'.$row['pre_comparison_master_data_id'].'" title="Click to deactivate in RMM" class="text-primary onRmm" href="javascript:void(0)"><i class="fas fa-check"></i></a> ';
                                                                                }else{
                                                                                    echo '<a id="rmm_'.$row['pre_comparison_master_data_id'].'" title="Click to activate in RMM" class="text-primary onRmm" href="javascript:void(0)"><i class="fas fa-window-minimize"></i></a> ';
                                                                                }
                                                                            }else{
                                                                                echo "-";
                                                                            }
                                                                    ...
                                                                    <td style="width: 11%;"><?php echo date('d/m/Y h:i A', strtotime($row['ersteller_datum'])); ?></td>
                                                                    <td style="width: 14%;">
                                                                        <?php
                                                                            $arzneiTitle = "";
                                                                    ...
                                                                    <td  class="text-center" style="width: 8%;">
                                                                        <?php if($row['is_synonyms_up_to_date'] == 1) { ?>
                                                                            <a id="" title="Synonyms are Update" class="text-primary" href="javascript:void(0)"><i class="fas fa-check"></i></a> 
                                                                        <?php } else { ?>
                                                                            <a id="" title="Update the synonym" class="text-primary synonym-up-to-date-btn" data-quelle-id="<?php echo $row['quelle_id']; ?>" data-arznei-id="<?php echo $row['arznei_id']; ?>" data-quelle-import-master-id="<?php echo $row['id']; ?>" href="javascript:void(0)">Update</a> 
                                                                        <?php } ?>
                                                                    </td>
                                                                    <!-- <td style="width: 15%;">
                                                                        <a class="text-info history-table-anchor-tag" href="comparison.php?comid=<?php //echo $row['id']; ?>">Ongoing vesrion</a>
                                                                    </td>  -->
                                                                    <!-- <td style="width: 9%;" class="text-center">
                                                                        <?php //if($row['comparison_save_status'] == 1){ ?>
                                                                            <input type="checkbox" name="comparison_save_status" id="comparison_save_status" value="1">
                                                                        <?php //}else{ echo "-"; } ?>
                                                                    </td> --> 
                                                                    <td id="edit_container_<?php echo $row['quelle_id']; ?>" style="width: 3%;" class="text-center">
                                                                        <?php if($row['quelle_type_id'] == 3 AND $row['comparison_save_status'] == 2){ ?>
                                                                            <a id="edit_<?php echo $row['quelle_id']; ?>" data-quelle-id="<?php echo $row['quelle_id']; ?>" data-arznei-id="<?php echo $row['arznei_id']; ?>" data-existing-comparison-name="<?php echo $quelle_name; ?>" data-pre-comparison-master-data-id="<?php echo $row['pre_comparison_master_data_id']; ?>" title="Edit comparison name" class="text-info edit-comparison-name" href="javascript:void(0)"><i class="fas fa-edit mm-fa-icon"></i></a>
                                                                        <?php } else { echo '-'; }  ?>
                                                                    </td>
                                                                    <td id="de_translation_btn_container_<?php echo $row['id']; ?>" class="text-center" style="width: 5%;">
                                                                        <?php if($row['is_symptoms_available_in_de'] == 1) { ?>
                                                                            ...
                                                                            /
                                                                            <a id="download_in_doc_<?php echo $row['quelle_id']; ?>" title="Download in Word Document" class="text-primary download-source" data-is-saved="<?php echo $isSaved; ?>" data-quelle-import-master-id="<?php echo $row['id']; ?>" data-language="de" href="javascript:void(0)"><i class="fas fa-download mm-fa-icon"></i></a>
                                                                        <?php 
                                                                            } 
                                                                            else 
                                                                            {
                                                                    ...
                                                                    <td id="en_translation_btn_container_<?php echo $row['id']; ?>" class="text-center" style="width: 5%;">
                                                                        <?php if($row['is_symptoms_available_in_en'] == 1) { ?>
                                                                            ...
                                                                            /
                                                                            <a id="download_in_doc_<?php echo $row['quelle_id']; ?>" title="Download in Word Document" class="text-primary download-source" data-is-saved="<?php echo $isSaved; ?>" data-quelle-import-master-id="<?php echo $row['id']; ?>" data-language="en" href="javascript:void(0)"><i class="fas fa-download mm-fa-icon"></i></a>
                                                                        <?php 
                                                                            } 
                                                                            else 
                                                                            {
                                                                    ...
                                                                    <td style="width: 3%;" class="text-center">
                                                                        ...
                                                                        <a id="delete_<?php echo $row['id']; ?>" onclick="deleteTheComparison('<?php echo $row['pre_comparison_master_data_id']; ?>')" class="text-danger history-table-anchor-tag" href="javascript:void(0)"><i class="fas fa-trash-alt mm-fa-icon"></i></a>
                                                                        <?php } else { ?>
