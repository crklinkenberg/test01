<?php
	...
	/*
	* Performing applicable connections related operations
	*/
?>
<?php
	$stopWords = array();
				...
				case 'get_nsc_note':
					{
						...
						if($initial_source_symptom_id != "" AND $comparing_source_symptom_id != ""){
							$connectedSymptomResult = mysqli_query($db, "SELECT id, is_connected, is_ns_connect, ns_connect_note FROM symptom_connections WHERE ((initial_source_symptom_id = '".$initial_source_symptom_id."' OR comparing_source_symptom_id = '".$initial_source_symptom_id."') AND (initial_source_symptom_id = '".$comparing_source_symptom_id."' OR comparing_source_symptom_id = '".$comparing_source_symptom_id."'))");
				...
				case 'get_nsp_note':
					{
						...
						$comparing_source_symptom_id = (isset($_POST['comparing_source_symptom_id']) AND $_POST['comparing_source_symptom_id'] !="" ) ? mysqli_real_escape_string($db, $_POST['comparing_source_symptom_id']) : "";
						if($initial_source_symptom_id != "" AND $comparing_source_symptom_id != ""){
							$connectedSymptomResult = mysqli_query($db, "SELECT id, is_pasted, is_ns_paste, ns_paste_note FROM symptom_connections WHERE ((initial_source_symptom_id = '".$initial_source_symptom_id."' OR comparing_source_symptom_id = '".$initial_source_symptom_id."') AND (initial_source_symptom_id = '".$comparing_source_symptom_id."' OR comparing_source_symptom_id = '".$comparing_source_symptom_id."'))");
							if(mysqli_num_rows($connectedSymptomResult) > 0){
								$conRow = mysqli_fetch_assoc($connectedSymptomResult);
								$rowId = $conRow['id'];
								$data = array();
