...
if(isset($_POST['no']) AND $_POST['no'] == "No"){
	...
	if(isset($_POST['suggested_pruefer']) AND $_POST['suggested_pruefer'] != ""){
		...
		try {
			...
			$tempApprovedPrueferQuery = "INSERT INTO temp_approved_pruefer (master_id, symptom_id, pruefer_id, approval_string) VALUES ('".$_POST['master_id']."', '".$_POST['symptom_id']."', '".$_POST['suggested_pruefer']."', NULLIF('".$approval_string."', ''))";
	...
	try {
	    ...
	    if($isPruferFoundInDb == 1 AND (isset($prueferArray[0]['pruefer_id']) AND $prueferArray[0]['pruefer_id'] != "")){
			...
			// Storing in temp_approved_pruefer for searching in case of a. a. O.
			$approval_string = base64_decode($_POST['approval_string']);
			$tempApprovedPrueferQuery = "INSERT INTO temp_approved_pruefer (master_id, symptom_id, pruefer_id, approval_string) VALUES ('".$_POST['master_id']."', '".$_POST['symptom_id']."', '".$foundPrueferId."', NULLIF('".$approval_string."', ''))";
			$db->query($tempApprovedPrueferQuery);
			...
			if($mainPrueferId != ""){
				...
				// Storing in temp_approved_pruefer for searching in case of a. a. O.
				$approval_string = base64_decode($_POST['approval_string']);
				$tempApprovedPrueferQuery = "INSERT INTO temp_approved_pruefer (master_id, symptom_id, pruefer_id, approval_string) VALUES ('".$_POST['master_id']."', '".$_POST['symptom_id']."', '".$mainPrueferId."', NULLIF('".$approval_string."', ''))";
				$db->query($tempApprovedPrueferQuery);
