	        ...
	        <div id="search_container" class="modal-body">
	        	<form id="symptom_search_modal_form" name="symptom_search_modal_form" action="" method="POST">
					...
					<div class="row">
						...
						<div class="col-sm-12">
							<div class="form-group Text_form_group">
								<label class="search-label">Searching symptom</label>
								<input type="text" name="searching_symptom" id="searching_symptom" class="form-control" placeholder="Search">
								<span class="error-text"></span>
						...
						<div class="col-sm-12">
							<div class="form-group">
								<button type="submit" id="search_mobal_submit_btn" class="btn btn-success">SEARCH</button>
							</div>
						</div>
						<div class="col-sm-12">
							<div class="spacer15"></div>
							<label class="search-result-label">Search Result</label>
							<div class="symptom-row heading">
								<div style="width: 12%;" class="source-code heading text-center">Source</div>
								<div style="width: 76%;" class="symptom heading text-center">Symptom</div>
								<div style="width: 12%;" class="percentage heading text-center">Match (%)</div>
							</div>
							<div id="searchResultTbody">
